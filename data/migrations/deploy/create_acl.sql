...
CREATE VIEW booking_for_visitor AS (
    ...
    attraction.id AS attractionId, name, capacity, open_time, close_time, duration FROM booking
...
CREATE VIEW attraction_with_incident AS (
    SELECT 
    attraction.id AS attractionId, name, capacity, open_time, close_time, duration,
